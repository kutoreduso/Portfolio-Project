...
const projects = [
  { title: "CCS Nexus", img: "/projects/ccsnexus.png", tech: "PHP • MySQL", link: "#" },
  { title: "TaskFlow", img: "/projects/taskflow.png", tech: "PHP • MySQL", link: "#" },
  { title: "KOI FISH (Color Grading)", img: "/img/Koi.png", tech: "Photoshop", link: "#" },
  { title: "SCENT ATELIER (Work In Progress)", img: "/projects/scentology.png", tech: "React • Tailwind v4 • GSAP", link: "#" },
  { title: "Lume Studio", img: "/projects/lume-studio.png", tech: "React • Tailwind v4 • GSAP", link: "https://lumestudiomedia.vercel.app/" }
];
        ...
        <div className="flex flex-col border-t border-zinc-800">
          {projects.map((project, i) => (
            <a 
              ...
              className="group flex items-center justify-between p-10 border-b border-zinc-800 hover:bg-zinc-900/50 transition-colors cursor-pointer no-underline"
            >
              <h2 className="md:text-6xl text-3xl font-bold uppercase tracking-tighter transition-all group-hover:pl-4">
                {project.title}
              </h2>
